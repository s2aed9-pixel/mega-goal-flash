...
function checkPhrases() {
	...
	if (this._currentframe == 1) {
		...
		for (var i=0; i<numberOfPhrases; i++) {
			theMovie.text_1_mc.text_2_mc.text_3_mc.text_4_mc["p"+i+"_mc"].gotoAndStop(2);
			theMovie.text_1_mc.text_2_mc.text_3_mc.text_4_mc["p"+i+"_mc"].pressed = true;
			theMovie.text_1_mc.text_2_mc.text_3_mc.text_4_mc["phrase"+i+"_mc"].gotoAndStop(2);
			theMovie.text_1_mc.text_2_mc.text_3_mc.text_4_mc["phrase"+i+"_mc"].text_txt.text = theMovie.text_1_mc.text_2_mc.text_3_mc.text_4_mc["p"+i+"_mc"].myText;
		...
		this.gotoAndStop(1);
		for (var i=0; i<numberOfPhrases; i++) {
			theMovie.text_1_mc.text_2_mc.text_3_mc.text_4_mc["p"+i+"_mc"].gotoAndStop(1);
			theMovie.text_1_mc.text_2_mc.text_3_mc.text_4_mc["p"+i+"_mc"].pressed = false;
...
function showPhrase() {
	if (!this.pressed) {
		...
		theMovie.text_1_mc.text_2_mc.text_3_mc.text_4_mc["p"+this.idNumber+"_mc"].gotoAndStop(2);
		this.pressed = true;
		// AUDIOScript Justification
		...
		theMovie.text_1_mc.text_2_mc.text_3_mc.text_4_mc["p"+this.idNumber+"_mc"].gotoAndStop(1);
		this.pressed = false;
...
function initPhrases() {
	for (var i = 0; i<numberOfPhrases; i++) {
		theMovie.text_1_mc.text_2_mc.text_3_mc.text_4_mc["p"+i+"_mc"].idNumber = i;
		theMovie.text_1_mc.text_2_mc.text_3_mc.text_4_mc["p"+i+"_mc"].myText = theMovie.complete_array[i];
		theMovie.text_1_mc.text_2_mc.text_3_mc.text_4_mc["p"+i+"_mc"].pressed = false;
		theMovie.text_1_mc.text_2_mc.text_3_mc.text_4_mc["p"+i+"_mc"].onRelease = showPhrase;
		//
		theMovie.text_1_mc.text_2_mc.text_3_mc.text_4_mc["phrase"+i+"_mc"].text_txt.text = "";
		theMovie.text_1_mc.text_2_mc.text_3_mc.text_4_mc["phrase"+i+"_mc"].background_mc._visible = false;
